...
module.exports.createComment = async (req, res) => {
    try {
        ...
        await Repairs.findByIdAndUpdate(req.params.pid, {
...
module.exports.deleteComment = async (req, res) => {
    try {
        ...
        // then use the repaur Item's id to find the post
        await Repairs.findByIdAndUpdate(req.params.pid, {
...
module.exports.indexComment = async (req, res) => {
    try {
        ...
        const repairItem = await Repairs.findById(req.params.pid).populate('comments')
        res.json(repairItem.comments)
    } catch(err) {
        res.status(400).json({ error: err.message })
    }
}
